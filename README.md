...
- **Optional real LLM adapter**: Can be enabled via environment variables (see [LLM Adapter docs](docs/LLM_ADAPTER.md)), but defaults to mock. Not configured = not used.
...
- **Frontend frozen**: Frontend is a legacy static demo, not maintained.
